...
git_repo="git@github.com:skulumani/2017_AAS_fall_presentation.git"
bb_repo="git@bitbucket.org:shankarkulumani/2017_aas_fall_presentation.git"
fdcl_repo="git@github.com:fdcl-gwu/2017_AAS_fall_presentation.git"
